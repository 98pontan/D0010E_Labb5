...
public class StoreView extends SimView {
  ...
  private void printEnd(Event e) {
    ...
    System.out.println("   Genomsnittlig ledig kassatid: " + timeFormat(storeState.getCheckoutFreeTime()/storeState.getAvailableCheckouts())
            + " te (dvs " + timeFormat((storeState.getCheckoutFreeTime()/storeState.getAvailableCheckouts() / storeState.getLastEvent().getTime())*100)  + "% av tiden från öppning tills sista kunden betalat).");
    System.out.println("");
