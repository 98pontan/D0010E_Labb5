...
public class StoreView extends SimView {
  ...
  private void printEnd(){
    ...
    System.out.println("   Genomsnittlig ledig kassatid: " + timeFormat(storeState.getCheckoutFreeTime()/storeState.getAvailableCheckouts())
            + " te (dvs " + timeFormat(((storeState.getCheckoutFreeTime()/storeState.getAvailableCheckouts())/storeState.getCurrentTime())*100)  + "% av tiden fr̴n ̦ppning tills sista kunden betalat).");
    System.out.println("");
